...
class BilibiliPlayer(BilibiliClientBase):
    ...
    async def get_playlist(self, url: str) -> Dict[str, Any]:
        ...
        pages = self._normalize_video_summary(video).get("pages", [])
    ...
    async def _get_video_info(self, bvid: str) -> Dict[str, Any]:
        ...
        try:
            ...
            summary["stats"] = {
                "views": summary["stats"]["views_formatted"],
                "danmaku": summary["stats"]["danmaku"],
                "likes": summary["stats"]["likes_formatted"],
            }
            summary.pop("raw", None)
            summary.pop("page_count", None)
            return self._success(**summary)
        except Exception as exc:
            return self._failure(str(exc), bvid=bvid)
    ...
    async def _get_play_url(self, bvid: str, quality: str, page: int) -> Dict[str, Any]:
        ...
        try:
            ...
            return {"play_url": None, "message": str(exc)}
