...
| `start_live_session` | Start Bilibili live, optionally absorb `title` / `announcement` / `area_id` pre-start patching, capture RTMP target, apply to OBS, optionally start OBS output |
